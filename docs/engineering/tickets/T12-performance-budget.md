...
反算校验：候选 8 / 64 / 256 / 1024 得 ¥0.001244 / 0.009953 / 0.039813 / 0.159252，与不变量一节
记录的 LIVE 锚点 ¥0.0012 / 0.0099 / 0.0397 / 0.1587 相差 **+3.68% / +0.54% / +0.28% / +0.35%**。
8 候选那档偏差最大不是公式漏了什么：查询本身的固定 token 在候选少时摊不薄，反过来从四个锚点
反算每候选 token 得 104 / 107 / 108 / 108，所以 108 取的是大候选档，而大候选档正是贵的那一档。
**实现的估值函数必须能在 ±5% 内复现这四个锚点**，这是可写成单元测试的断言，比「由候选数计算」
这句话可验证。
